# # retriever.py
# """
# RetrieverController: unified wrapper for BM25 and dense (Chroma-based) retrieval.
# Compatible with LangChain v0.2+ retriever API.
# """
...
#         """Load BM25 retriever (from local docs) — must be built once before use."""
...
#         """Build BM25 retriever once from list of LangChain Documents."""
...
#         """Use persistent Chroma store for dense retrieval."""
